...
# Run the command for jet properties in the first pane
tmux send-keys './write/jet_properties --use_opendata false --energy 14000 --isr on --fsr on --mpi on --pid_1 2212 --pid_2 2212 --outstate w --jet_rad 1.0 --pt_min 500 --pt_max 550 --minbin -6 --n_events 1000000 --file_prefix w_1M_500bins' C-m
