...
tmux send-keys './write/new_enc/2particle --use_opendata true --use_deltaR --use_pt --weights 9 19 49 99 199 --minbin -6 --n_events 100000 --nbins 200 --file_prefix od_100k_200bins' C-m
